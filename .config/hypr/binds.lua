...
hl.define_submap("global", function()
    ...
    -- To bind SUPER_L on its own, we use the SUPER modifier with the SUPER_L keysym
    hl.bind("SUPER + SUPER_L", hl.dsp.global("caelestia:launcher"), { ignore_mods = true })
    
    -- Catch-all (no modifier combination needed since ignore_mods is true)
    hl.bind("catchall", hl.dsp.global("caelestia:launcherInterrupt"), { ignore_mods = true, non_consuming = true })
    
    -- Mouse Binds updated to use SUPER modifier
