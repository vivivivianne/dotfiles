...
-- PLAYERCTL BINDS
	...
	hl.bind(
		"SUPER" .. " + " .. "A",
		hl.dsp.exec_cmd("kitty --single-instance --class=pavucontrol -T 'pavucontrol' -e pulsemixer")
	)
	hl.bind("SUPER+ALT" .. " + " .. "R", hl.dsp.exec_cmd("kitty --single-instance -e ranger"))
	hl.bind(
		"SUPER+SHIFT" .. " + " .. "x",
		hl.dsp.exec_cmd("kitty --single-instance --class=pavucontrol -T 'xplr' -e xplr")
	)
	...
	hl.bind(
		"SUPER" .. " + " .. "C",
		hl.dsp.exec_cmd("cliphist list| rofi -dmenu --allow-images| cliphist decode| wl-copy")
	)
	...
	hl.bind(
		"SUPER+ALT+SHIFT" .. " + " .. "R",
		hl.dsp.exec_cmd("hyprctl reload && qs -c caelestia kill; caelestia shell -d")
	)
...
hl.define_submap("resize", "reset", function()
    ...
    hl.bind("R", hl.dsp.submap("global"), { ignore_mods = true })
    hl.bind("catchall", hl.dsp.submap("global"), { ignore_mods = true, non_consuming = true })
    hl.bind("ESCAPE", hl.dsp.submap("global"))
end)
	-- Workspace binds
